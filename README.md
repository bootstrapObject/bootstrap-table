...
//        return totalCount;
        ...
        $("#changetable4Row").click(function(){
            /*
             *index {checked:0,createUserId:1, descrption :"fddsffdffdfdd",id:42,lockStatus:0,name:"t6s",success:null,updateTime:1507530545,userName:"admin"}
             *row 3 index
             */
            var selectRowId = $(".tabRowClickbg").attr("data-id"),
                    index = $(".tabRowClickbg").attr("data-index"),
